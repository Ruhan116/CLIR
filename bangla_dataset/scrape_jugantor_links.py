...
DEFAULT_SITEMAPS = [
    str(LOCAL_XML),
    "https://www.jugantor.com/sitemap.xml",
]

OUT_PATH = Path(__file__).resolve().parent / "jugantor_links"
...
def is_article_url(url: str) -> bool:
    # Accept jugantor article pages; exclude AMP and media
    if "/amp/" in url:
        return False
    try:
        ...
        return False
    return h.endswith("jugantor.com")
