...
def main() -> int:
	url = "https://www.thedailystar.net/sitemap.xml?page=1"
	try:
	...
	# links is a Python list containing all href/loc links
	# Print the first 5
	for item in links[:5]:
		print(item)

	# Save all links to a file
	links_file = 'daily_star_links'
	try:
	...
	# No category extraction: done. (Only links are saved.)
